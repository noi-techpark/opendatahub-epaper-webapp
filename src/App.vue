...
<template>
    <div id="app">
        <div v-if="authenticated" class="topbar">
            ...
            <a href="https://noi.bz.it/">
                <img
                    class="logo"
                    alt="Vue logo"
                    src="./assets/logo_bn.svg"
                />
            </a>
            <a href="https://opendatahub.com/">
                <img
                    class="logo-noi"
                    alt="Vue logo"
                    src="https://opendatahub.com/img/NOI_OPENDATAHUB_NEW_BK_nospace-01.svg"
                />
            </a>
            ...
            <b-nav class="navbar">
                ...
                <div class="userBox">
                    Hi, {{ username }}
                    <b-nav-item v-if="username" v-on:click="logout()"
                        >Logout</b-nav-item
                    >
                </div>
            </b-nav>
